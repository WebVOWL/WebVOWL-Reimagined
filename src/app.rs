                ...
                <div class="flex fixed bottom-0 left-0 flex-row flex-wrap p-0 font-mono text-white">
                    <ConfigProvider>
                        ...
                        <Menu on_select=on_select position=MenuPosition::Top>
                            ...
                            <Button on_click=move |_| select_ontology(
                                "Friend of a Friend (FOAF) vocabulary",
                            )>"Friend of a Friend (FOAF) vocabulary"</Button>
                            <Button on_click=move |_| select_ontology(
                                "GoodRelations Vocabulary for E-Commerce",
                            )>"GoodRelations Vocabulary for E-Commerce"</Button>
                            <Button on_click=move |_| select_ontology(
                                "Modular and Unified Tagging Ontology (MUTO)",
                            )>"Modular and Unified Tagging Ontology (MUTO)"</Button>
                            <Button on_click=move |_| select_ontology(
                                "Personas Ontology (PersonasOnto)",
                            )>"Personas Ontology (PersonasOnto)"</Button>
                            <Button on_click=move |_| select_ontology(
                            ...
                            )>"Benchmark Graph for VOWL"</Button>
                        ...
                        <Menu on_select position=MenuPosition::Top>
                            ...
                            <Checkbox
                                checked=datatypepropertycheck
                                label="Datatype properties"
                            />
                            <Checkbox
                                checked=objectpropertycheck
                                label="Object properties"
                            />
                            <Checkbox
                                checked=solitarypropertycheck
                                label="Solitary properties"
                            />
                            <Checkbox
                                checked=classdisjointnesscheck
                                label="Class disjointness"
                            />
                            <Checkbox checked=setoperatorscheck label="Set operators" />
                            <Slider
                                value=degreeofcollapsingcheck
                                max=16.0
                                step=1.0
                                show_stops=false
                            />
                        ...
                        <Menu on_select position=MenuPosition::Top>
                            ...
                            <Checkbox
                                checked=dynamiclabelcheck
                                label="Dynamic labels"
                            />
                            <Slider
                                value=maxlabelwidthvalue
                                max=600.0
                                step=10.0
                                show_stops=false
                            />
                            ...
                            <Checkbox
                                checked=compactnotationcheck
                                label="Compact notation"
                            />
                            <Checkbox
                                checked=colorexternalscheck
                        ...
                        <Menu on_select position=MenuPosition::Top>
                            ...
                            <Caption1Strong>
                                "WebVOWL-Reimagined Developers:"
                            </Caption1Strong>
                            <Caption1Strong>
                                "Kneckerino, KristianEmilWN, nikarnik,TheRealMorgenfrue"
                            </Caption1Strong>
                    ...
                    <div class="accordion-header">
                        ...
                        <Accordion collapsible=true multiple=true>
                            <AccordionItem value="statistics">
                                <AccordionHeader slot>"Statistics"</AccordionHeader>
                                <div class="info-section-content">
                                    ...
                                    <p>
                                        "Datatype Properties: "
                                        {move || datatypepropertycount.get()}
                                    </p>
                        ...
                        <Accordion collapsible=true multiple=true>
                            <AccordionItem value="selection details">
                                <AccordionHeader slot>"Selection Details"</AccordionHeader>
                                <p class="info-section-content">
