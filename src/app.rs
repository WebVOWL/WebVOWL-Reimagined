                ...
                <div class="accordion-header">
                    <Accordion collapsible=true multiple=true>
                        <AccordionItem value="description">
                            ...
                            <p id="description" class="info-section-content">
                    ...
                    <Accordion collapsible=true multiple=true>
                        <AccordionItem value="setadata">
                            ...
                            <p id="metadata" class="info-section-content">
                    ...
                    <Accordion collapsible=true multiple=true>
                        <AccordionItem value="selection details">
                            ...
                            <p id="selection_details" class="info-section-content">
